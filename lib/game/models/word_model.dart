...
class Word extends Equatable{
  ...
  @override
  List<Object?> get props => [letters]; // List of properties needed to check Equatable
  ...
  factory Word.fromString(String word) => 
    ...
    Word(letters: word.split('').map((e) => 
      Letter(value: e)).toList());
